...
// AddList
var listop = document.querySelector(".listoption");
document.getElementById("sidebarAction").addEventListener('click', AddList);

function AddList(e) {
    e.stopPropagation();

    if (listop.style.display == 'none') {
        listop.style.width = "100%";
        listop.style.height = "100%";
        listop.style.zIndex = "1";
        listop.style.display = 'block';
    } else {
        listop.style.width = "0";
        listop.style.height = "0";
        listop.style.zIndex = "unset";
        listop.style.display = 'none';
    }
...
document.getElementById("delete3").addEventListener('click', DeleList);

function DeleList() {
    // console.log(document.getElementsByClassName("activeTb")[0].innerHTML);
    document.getElementsByClassName("activeTb")[0].remove();
    document.getElementsByClassName("ContextList")[0].style.display = 'none';
...
function ContextmenuDele(e) {
    ...
    // var getbound = taskItem[0].getBoundingClientRect();
    document.getElementsByClassName("Context-menudele")[0].style.left = posx;
    document.getElementsByClassName("Context-menudele")[0].style.top = posy;
    // document.getElementById("Context-menu").innerHTML = 'x = ' + posx + ' y=' + posy;
...
window.addEventListener('load', function() {
    ...
    //     if (mainright.style.display = 'block' && (e.target.id != "main-right  ") && (!mainright.contains(e.target))) {
...
function ListToogle(e) {
    ...
    if (document.getElementById("slide").style.width == "280px") {
        ...
        var x = matchMedia("(max-width:1024px)");
        HienListToogle(x);
